...
import { buildBreadcrumb, getChildren, getTopicWithChildren, Topic } from "@/lib/topics";
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {topic.level === 1 || topic.level === 2 ? (
          <>
            ...
            <section className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-semibold text-foreground">Latest from {topic.label}</h2>
