...
BEGIN
    BEGIN
        ALTER TABLE public.drops ALTER COLUMN l1_topic_id SET NOT NULL;
    EXCEPTION
        WHEN duplicate_object THEN NULL;
    END;
    
    BEGIN
        ALTER TABLE public.drops ALTER COLUMN l2_topic_id SET NOT NULL;
    EXCEPTION
        WHEN duplicate_object THEN NULL;
    END;
END $$;
...
BEGIN
    BEGIN
        ALTER TABLE public.drops ADD CONSTRAINT fk_drops_l1_topic FOREIGN KEY (l1_topic_id) REFERENCES public.topics(id);
    EXCEPTION
        WHEN duplicate_object THEN NULL;
    END;
    
    BEGIN
        ALTER TABLE public.drops ADD CONSTRAINT fk_drops_l2_topic FOREIGN KEY (l2_topic_id) REFERENCES public.topics(id);
    EXCEPTION
        WHEN duplicate_object THEN NULL;
    END;
END $$;
...
-- Step 7: Add check constraints for tag validation (if not exists)
DO $$ 
BEGIN
    BEGIN
        ALTER TABLE public.drops ADD CONSTRAINT chk_tags_l3_only CHECK (
